...
public class DAStructureTypes {
    ...
    public static final DeferredHolder<StructureType<?>, StructureType<DAJigsawStructure>> DA_JIGSAW = STRUCTURE_TYPES.register("deep_aether_jigsaw", () -> () ->  DAJigsawStructure.CODEC);
}
